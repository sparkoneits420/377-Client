...
public class Class15 {
    ...
    public static void method207(Class2 class2, int i) {
        if (i != 36135)
            return;
        Stream class50_sub1_sub2 = new Stream(true, class2.method154("flo.dat", null));
        ...
        for (int j = 0; j < anInt313; j++) {
            ...
            aClass15Array314[j].method208(aByte310, class50_sub1_sub2);
        }

    }

    public void method208(byte byte0, Stream class50_sub1_sub2) {
        if (byte0 == 6) {
            byte0 = 0;
        } else {
            for (int i = 1; i > 0; i++) ;
