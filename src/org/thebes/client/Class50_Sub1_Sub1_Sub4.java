...
public class Class50_Sub1_Sub1_Sub4 extends Class50_Sub1_Sub1 {
    ...
    public static void method493(int i) {
        i = 19 / i;
        anIntArray1538 = new int[anInt1426];
        for (int j = 0; j < anInt1426; j++)
            anIntArray1538[j] = anInt1425 * j;

        anInt1532 = anInt1425 / 2;
        anInt1533 = anInt1426 / 2;
    }
    ...
    public static void method503(int i, int j, int k, int l, int i1, int j1, int k1, int l1,
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && j3 < j2 || i == j && j3 > l2) {
                    k -= j;
                    j -= i;
                    for (i = anIntArray1538[i]; --j >= 0; i += anInt1425) {
                        method504(anIntArray1424, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while (--k >= 0) {
                        method504(anIntArray1424, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                ...
                j -= i;
                for (i = anIntArray1538[i]; --j >= 0; i += anInt1425) {
                    method504(anIntArray1424, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while (--k >= 0) {
                    method504(anIntArray1424, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if (i != k && j3 < j2 || i == k && l2 > j2) {
                j -= k;
                k -= i;
                for (i = anIntArray1538[i]; --k >= 0; i += anInt1425) {
                    method504(anIntArray1424, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            k -= i;
            for (i = anIntArray1538[i]; --k >= 0; i += anInt1425) {
                method504(anIntArray1424, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && j2 < l2 || j == k && j2 > j3) {
                    i -= k;
                    k -= j;
                    for (j = anIntArray1538[j]; --k >= 0; j += anInt1425) {
                        method504(anIntArray1424, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while (--i >= 0) {
                        method504(anIntArray1424, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                ...
                k -= j;
                for (j = anIntArray1538[j]; --k >= 0; j += anInt1425) {
                    method504(anIntArray1424, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while (--i >= 0) {
                    method504(anIntArray1424, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if (j2 < l2) {
                k -= i;
                i -= j;
                for (j = anIntArray1538[j]; --i >= 0; j += anInt1425) {
                    method504(anIntArray1424, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            i -= j;
            for (j = anIntArray1538[j]; --i >= 0; j += anInt1425) {
                method504(anIntArray1424, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if (i < j) {
            ...
            if (l2 < j3) {
                j -= i;
                i -= k;
                for (k = anIntArray1538[k]; --i >= 0; k += anInt1425) {
                    method504(anIntArray1424, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while (--j >= 0) {
                    method504(anIntArray1424, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
            ...
            i -= k;
            for (k = anIntArray1538[k]; --i >= 0; k += anInt1425) {
                method504(anIntArray1424, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while (--j >= 0) {
                method504(anIntArray1424, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if (l2 < j3) {
            i -= j;
            j -= k;
            for (k = anIntArray1538[k]; --j >= 0; k += anInt1425) {
                method504(anIntArray1424, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        j -= k;
        for (k = anIntArray1538[k]; --j >= 0; k += anInt1425) {
            method504(anIntArray1424, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
    ...
    public static void method505(int i, int j, int k, int l, int i1, int j1, int k1) {
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && j2 < l1 || i == j && j2 > i2) {
                    ...
                    j -= i;
                    for (i = anIntArray1538[i]; --j >= 0; i += anInt1425) {
                        method506(anIntArray1424, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }

                    while (--k >= 0) {
                        method506(anIntArray1424, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += anInt1425;
                    }
                ...
                j -= i;
                for (i = anIntArray1538[i]; --j >= 0; i += anInt1425) {
                    method506(anIntArray1424, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }

                while (--k >= 0) {
                    method506(anIntArray1424, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += anInt1425;
                }
            ...
            if (i != k && j2 < l1 || i == k && i2 > l1) {
                ...
                k -= i;
                for (i = anIntArray1538[i]; --k >= 0; i += anInt1425) {
                    method506(anIntArray1424, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
            ...
            k -= i;
            for (i = anIntArray1538[i]; --k >= 0; i += anInt1425) {
                method506(anIntArray1424, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && l1 < i2 || j == k && l1 > j2) {
                    ...
                    k -= j;
                    for (j = anIntArray1538[j]; --k >= 0; j += anInt1425) {
                        method506(anIntArray1424, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }

                    while (--i >= 0) {
                        method506(anIntArray1424, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += anInt1425;
                    }
                ...
                k -= j;
                for (j = anIntArray1538[j]; --k >= 0; j += anInt1425) {
                    method506(anIntArray1424, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }

                while (--i >= 0) {
                    method506(anIntArray1424, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += anInt1425;
                }
            ...
            if (l1 < i2) {
                ...
                i -= j;
                for (j = anIntArray1538[j]; --i >= 0; j += anInt1425) {
                    method506(anIntArray1424, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
            ...
            i -= j;
            for (j = anIntArray1538[j]; --i >= 0; j += anInt1425) {
                method506(anIntArray1424, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
        ...
        if (i < j) {
            ...
            if (i2 < j2) {
                ...
                i -= k;
                for (k = anIntArray1538[k]; --i >= 0; k += anInt1425) {
                    method506(anIntArray1424, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }

                while (--j >= 0) {
                    method506(anIntArray1424, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += anInt1425;
                }
            ...
            i -= k;
            for (k = anIntArray1538[k]; --i >= 0; k += anInt1425) {
                method506(anIntArray1424, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }

            while (--j >= 0) {
                method506(anIntArray1424, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += anInt1425;
            }
        ...
        if (i2 < j2) {
            ...
            j -= k;
            for (k = anIntArray1538[k]; --j >= 0; k += anInt1425) {
                method506(anIntArray1424, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
        ...
        j -= k;
        for (k = anIntArray1538[k]; --j >= 0; k += anInt1425) {
            method506(anIntArray1424, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
    ...
    public static void method507(int i, int j, int k, int l, int i1, int j1, int k1, int l1,
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && i8 < i7 || i == j && i8 > k7) {
                    ...
                    i = anIntArray1538[i];
                    while (--j >= 0) {
                        method508(anIntArray1424, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                        k1 += j7;
                    ...
                    while (--k >= 0) {
                        method508(anIntArray1424, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
                        l1 += l7;
                ...
                i = anIntArray1538[i];
                while (--j >= 0) {
                    method508(anIntArray1424, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                    k1 += j7;
                ...
                while (--k >= 0) {
                    method508(anIntArray1424, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    i1 += k7;
                    i2 += j8;
                    l1 += l7;
            ...
            if (i != k && i8 < i7 || i == k && k7 > i7) {
                ...
                i = anIntArray1538[i];
                while (--k >= 0) {
                    method508(anIntArray1424, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                    k1 += j7;
            ...
            i = anIntArray1538[i];
            while (--k >= 0) {
                method508(anIntArray1424, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
                k1 += j7;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && i7 < k7 || j == k && i7 > i8) {
                    ...
                    j = anIntArray1538[j];
                    while (--k >= 0) {
                        method508(anIntArray1424, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                        l1 += l7;
                    ...
                    while (--i >= 0) {
                        method508(anIntArray1424, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                        i2 += j8;
                ...
                j = anIntArray1538[j];
                while (--k >= 0) {
                    method508(anIntArray1424, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                    l1 += l7;
                ...
                while (--i >= 0) {
                    method508(anIntArray1424, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
                    i2 += j8;
            ...
            if (i7 < k7) {
                ...
                j = anIntArray1538[j];
                while (--i >= 0) {
                    method508(anIntArray1424, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                    l1 += l7;
            ...
            j = anIntArray1538[j];
            while (--i >= 0) {
                method508(anIntArray1424, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
                l1 += l7;
        ...
        if (i < j) {
            ...
            if (k7 < i8) {
                ...
                k = anIntArray1538[k];
                while (--i >= 0) {
                    method508(anIntArray1424, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                    i2 += j8;
                ...
                while (--j >= 0) {
                    method508(anIntArray1424, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
                    k1 += j7;
            ...
            k = anIntArray1538[k];
            while (--i >= 0) {
                method508(anIntArray1424, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
                i2 += j8;
            ...
            while (--j >= 0) {
                method508(anIntArray1424, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
                k1 += j7;
        ...
        if (k7 < i8) {
            ...
            k = anIntArray1538[k];
            while (--j >= 0) {
                method508(anIntArray1424, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
                i2 += j8;
        ...
        k = anIntArray1538[k];
        while (--j >= 0) {
            method508(anIntArray1424, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
            i2 += j8;
