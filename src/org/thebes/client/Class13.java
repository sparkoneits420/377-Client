...
public class Class13 {
    ...
    public static Class50_Sub1_Sub1_Sub1 method194(int i, String s, int j) {
        long l = (ChatUtil.method301(183, s) << 8) + (long) i;
        if (j <= 0)
            anInt275 = -317;
    ...
    public static Class13 method195(int i) {
        if (aClass13Array216[i] == null) {
            Stream class50_sub1_sub2 = new Stream(true, aByteArrayArray282[i]);
    ...
    public static Class13 method198(int i, Stream class50_sub1_sub2, int j, int k) {
    ...
    public static void method199(int i, Class50_Sub1_Sub1_Sub2 aclass50_sub1_sub1_sub2[], Class2 class2, Class2 class2_1) {
        ...
        int j = -1;
        Stream class50_sub1_sub2 = new Stream(true, class2.method154("data", null));
