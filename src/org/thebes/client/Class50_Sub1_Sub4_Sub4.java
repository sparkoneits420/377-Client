...
public class Class50_Sub1_Sub4_Sub4 extends Class50_Sub1_Sub4 {
    ...
    public static Class50_Sub1_Sub4_Sub4 aClass50_Sub1_Sub4_Sub4_1643 = new Class50_Sub1_Sub4_Sub4(852);
    ...
    static {
        anIntArray1710 = Class50_Sub1_Sub1_Sub4.anIntArray1536;
        anIntArray1711 = Class50_Sub1_Sub1_Sub4.anIntArray1537;
        anIntArray1712 = Class50_Sub1_Sub1_Sub4.anIntArray1548;
        anIntArray1713 = Class50_Sub1_Sub1_Sub4.anIntArray1535;
    }
    ...
    public Class50_Sub1_Sub4_Sub4(int i) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
    ...
    public Class50_Sub1_Sub4_Sub4(int i, int j) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
        ...
        Stream class50_sub1_sub2 = new Stream(true, class26.aByteArray533);
        class50_sub1_sub2.anInt1454 = class26.anInt537;
        Stream class50_sub1_sub2_1 = new Stream(true, class26.aByteArray533);
        class50_sub1_sub2_1.anInt1454 = class26.anInt538;
        Stream class50_sub1_sub2_2 = new Stream(true, class26.aByteArray533);
        class50_sub1_sub2_2.anInt1454 = class26.anInt539;
        if (j >= 0)
            aBoolean1641 = !aBoolean1641;
        Stream class50_sub1_sub2_3 = new Stream(true, class26.aByteArray533);
        class50_sub1_sub2_3.anInt1454 = class26.anInt540;
        Stream class50_sub1_sub2_4 = new Stream(true, class26.aByteArray533);
    ...
    public Class50_Sub1_Sub4_Sub4(int i, Class50_Sub1_Sub4_Sub4 aclass50_sub1_sub4_sub4[], byte byte0) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
        ...
        anInt1663 = -1;
        for (int j = 0; j < i; j++) {
            Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4 = aclass50_sub1_sub4_sub4[j];
        ...
        int k = 0;
        for (int l = 0; l < i; l++) {
            Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_1 = aclass50_sub1_sub4_sub4[l];
            if (class50_sub1_sub4_sub4_1 != null) {
                for (int i1 = 0; i1 < class50_sub1_sub4_sub4_1.anInt1652; i1++) {
                    ...
                    anIntArray1653[anInt1652] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1653[i1]);
                    anIntArray1654[anInt1652] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1654[i1]);
                    anIntArray1655[anInt1652] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1655[i1]);
                    anInt1652++;
                }

                for (int k1 = 0; k1 < class50_sub1_sub4_sub4_1.anInt1664; k1++) {
                    anIntArray1665[anInt1664] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1665[k1]);
                    anIntArray1666[anInt1664] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1666[k1]);
                    anIntArray1667[anInt1664] = method580(class50_sub1_sub4_sub4_1, class50_sub1_sub4_sub4_1.anIntArray1667[k1]);
                    anInt1664++;
                }
    ...
    public Class50_Sub1_Sub4_Sub4(int i, boolean flag, int j, Class50_Sub1_Sub4_Sub4 aclass50_sub1_sub4_sub4[]) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
        ...
        anInt1663 = -1;
        for (int k = 0; k < i; k++) {
            Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4 = aclass50_sub1_sub4_sub4[k];
            if (class50_sub1_sub4_sub4 != null) {
                anInt1648 += class50_sub1_sub4_sub4.anInt1648;
                anInt1652 += class50_sub1_sub4_sub4.anInt1652;
                anInt1664 += class50_sub1_sub4_sub4.anInt1664;
        ...
        for (int i1 = 0; i1 < i; i1++) {
            Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4_1 = aclass50_sub1_sub4_sub4[i1];
            if (class50_sub1_sub4_sub4_1 != null) {
                int j1 = anInt1648;
    ...
    public Class50_Sub1_Sub4_Sub4(boolean flag, boolean flag1, boolean flag2, Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4, boolean flag3) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
    ...
    public Class50_Sub1_Sub4_Sub4(boolean flag, boolean flag1, int i, Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4) {
        anInt1636 = 932;
        anInt1637 = 426;
        aBoolean1638 = false;
        aBoolean1639 = true;
    ...
    public void method579(boolean flag, Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4, int i) {
        anInt1648 = class50_sub1_sub4_sub4.anInt1648;
        anInt1652 = class50_sub1_sub4_sub4.anInt1652;
        anInt1664 = class50_sub1_sub4_sub4.anInt1664;
    ...
    public int method580(Class50_Sub1_Sub4_Sub4 class50_sub1_sub4_sub4, int i) {
        int j = -1;
    ...
    public void method585(int i, byte byte0) {
        ...
        for (int j = 0; j < class21.anInt433; j++) {
            ...
            method587(class41.anIntArray698[k], class41.anIntArrayArray699[k], class21.anIntArray435[j], class21.anIntArray436[j], class21.anIntArray437[j]);
        }
    ...
    public void method586(int i, int j, int k, int ai[]) {
        ...
        for (int j1 = 0; j1 < class21.anInt433; j1++) {
            ...
            if (k1 != i1 || class41.anIntArray698[k1] == 0)
                method587(class41.anIntArray698[k1], class41.anIntArrayArray699[k1], class21.anIntArray435[j1], class21.anIntArray436[j1], class21.anIntArray437[j1]);
        }
        ...
        for (int l1 = 0; l1 < class21_1.anInt433; l1++) {
            ...
            if (i2 == i1 || class41.anIntArray698[i2] == 0)
                method587(class41.anIntArray698[i2], class41.anIntArrayArray699[i2], class21_1.anIntArray435[l1], class21_1.anIntArray436[l1], class21_1.anIntArray437[l1]);
        }
    ...
    public void method596(int i, int j, int k, int l, int i1) {
        for (int j1 = 0; j1 < anInt1652; j1++) {
            ...
            if (anIntArray1659 == null) {
                ...
                int k2 = i + (k * class40.anInt693 + l * class40.anInt694 + i1 * class40.anInt695) / (j * class40.anInt696);
                ...
                int l2 = i + (k * class40_1.anInt693 + l * class40_1.anInt694 + i1 * class40_1.anInt695) / (j * class40_1.anInt696);
                anIntArray1656[j1] = method597(j3, l2, k3);
                class40_1 = super.aClass40Array1474[i2];
                l2 = i + (k * class40_1.anInt693 + l * class40_1.anInt694 + i1 * class40_1.anInt695) / (j * class40_1.anInt696);
    ...
    public void method598(int i, int j, int k, int l, int i1, int j1, int k1) {
        int l1 = Class50_Sub1_Sub1_Sub4.anInt1532;
        int i2 = Class50_Sub1_Sub1_Sub4.anInt1533;
    ...
    public void method560(int i, int j, int k, int l, int i1, int j1, int k1,
        ...
        if (i2 > 0 && aBoolean1705) {
            ...
            int i6 = anInt1706 - Class50_Sub1_Sub1_Sub4.anInt1532;
            int k6 = anInt1707 - Class50_Sub1_Sub1_Sub4.anInt1533;
        ...
        int l5 = Class50_Sub1_Sub1_Sub4.anInt1532;
        int j6 = Class50_Sub1_Sub1_Sub4.anInt1533;
        int l6 = 0;
        int i7 = 0;
        if (i != 0) {
            l6 = anIntArray1710[i];
        ...
        for (int k = 0; k < anInt1652; k++)
            if (anIntArray1659 == null || anIntArray1659[k] != -1) {
                ...
                if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
                    ...
                    if (flag1 && method602(anInt1706, anInt1707, anIntArray1687[l], anIntArray1687[k1], anIntArray1687[j2], i3, l3, k4)) {
                        anIntArray1709[anInt1708++] = i;
                        flag1 = false;
                    }
                    if ((i3 - l3) * (anIntArray1687[j2] - anIntArray1687[k1]) - (anIntArray1687[l] - anIntArray1687[k1]) * (k4 - l3) > 0) {
                        aBooleanArray1685[k] = false;
                        if (i3 < 0 || l3 < 0 || k4 < 0 || i3 > Class50_Sub1_Sub1.anInt1431 || l3 > Class50_Sub1_Sub1.anInt1431 || k4 > Class50_Sub1_Sub1.anInt1431)
    ...
    public void method600(int i) {
        ...
        Class50_Sub1_Sub1_Sub4.aBoolean1528 = aBooleanArray1684[i];
        if (anIntArray1661 == null)
            Class50_Sub1_Sub1_Sub4.anInt1531 = 0;
        else
            Class50_Sub1_Sub1_Sub4.anInt1531 = anIntArray1661[i];
        int i1;
        if (anIntArray1659 == null)
            i1 = 0;
        else
        ...
        if (i1 == 0) {
            Class50_Sub1_Sub1_Sub4.method503(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i], anIntArray1658[i]);
            return;
        }
        if (i1 == 1) {
            Class50_Sub1_Sub1_Sub4.method505(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1712[anIntArray1656[i]]);
            return;
        }
        if (i1 == 2) {
            ...
            Class50_Sub1_Sub1_Sub4.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1657[i], anIntArray1658[i], anIntArray1689[l1], anIntArray1689[j2], anIntArray1689[l2], anIntArray1690[l1], anIntArray1690[j2], anIntArray1690[l2], anIntArray1691[l1], anIntArray1691[j2], anIntArray1691[l2], anIntArray1662[i]);
            return;
        }
        if (i1 == 3) {
            ...
            Class50_Sub1_Sub1_Sub4.method507(anIntArray1687[j], anIntArray1687[k], anIntArray1687[l], anIntArray1686[j], anIntArray1686[k], anIntArray1686[l], anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[i2], anIntArray1689[k2], anIntArray1689[i3], anIntArray1690[i2], anIntArray1690[k2], anIntArray1690[i3], anIntArray1691[i2], anIntArray1691[k2], anIntArray1691[i3], anIntArray1662[i]);
        }
    }

    public void method601(int i) {
        int j = Class50_Sub1_Sub1_Sub4.anInt1532;
        int k = Class50_Sub1_Sub1_Sub4.anInt1533;
        int l = 0;
        ...
        if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
            ...
            if (l == 3) {
                if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Class50_Sub1_Sub1.anInt1431 || j4 > Class50_Sub1_Sub1.anInt1431 || j5 > Class50_Sub1_Sub1.anInt1431)
                ...
                if (l7 == 0)
                    Class50_Sub1_Sub1_Sub4.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2]);
                else if (l7 == 1)
                    Class50_Sub1_Sub1_Sub4.method505(i7, j7, k7, j3, j4, j5, anIntArray1712[anIntArray1656[i]]);
                else if (l7 == 2) {
                    int j8 = anIntArray1659[i] >> 2;
                    int k9 = anIntArray1665[j8];
                    int k10 = anIntArray1666[j8];
                    int k11 = anIntArray1667[j8];
                    Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2], anIntArray1689[k9], anIntArray1689[k10], anIntArray1689[k11], anIntArray1690[k9], anIntArray1690[k10], anIntArray1690[k11], anIntArray1691[k9], anIntArray1691[k10], anIntArray1691[k11], anIntArray1662[i]);
                } else if (l7 == 3) {
                    int k8 = anIntArray1659[i] >> 2;
                    int l9 = anIntArray1665[k8];
                    int l10 = anIntArray1666[k8];
                    int l11 = anIntArray1667[k8];
                    Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[l9], anIntArray1689[l10], anIntArray1689[l11], anIntArray1690[l9], anIntArray1690[l10], anIntArray1690[l11], anIntArray1691[l9], anIntArray1691[l10], anIntArray1691[l11], anIntArray1662[i]);
                }
            }
            if (l == 4) {
                if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > Class50_Sub1_Sub1.anInt1431 || j4 > Class50_Sub1_Sub1.anInt1431 || j5 > Class50_Sub1_Sub1.anInt1431 || anIntArray1699[3] < 0 || anIntArray1699[3] > Class50_Sub1_Sub1.anInt1431)
                    Class50_Sub1_Sub1_Sub4.aBoolean1528 = true;
                int i8;
                if (anIntArray1659 == null)
                    i8 = 0;
                ...
                if (i8 == 0) {
                    Class50_Sub1_Sub1_Sub4.method503(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2]);
                    Class50_Sub1_Sub1_Sub4.method503(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1701[0], anIntArray1701[2], anIntArray1701[3]);
                    return;
                }
                if (i8 == 1) {
                    int l8 = anIntArray1712[anIntArray1656[i]];
                    Class50_Sub1_Sub1_Sub4.method505(i7, j7, k7, j3, j4, j5, l8);
                    Class50_Sub1_Sub1_Sub4.method505(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], l8);
                    return;
                }
                if (i8 == 2) {
                    ...
                    Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1701[0], anIntArray1701[1], anIntArray1701[2], anIntArray1689[i10], anIntArray1689[i11], anIntArray1689[i12], anIntArray1690[i10], anIntArray1690[i11], anIntArray1690[i12], anIntArray1691[i10], anIntArray1691[i11], anIntArray1691[i12], anIntArray1662[i]);
                    Class50_Sub1_Sub1_Sub4.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1701[0], anIntArray1701[2], anIntArray1701[3], anIntArray1689[i10], anIntArray1689[i11], anIntArray1689[i12], anIntArray1690[i10], anIntArray1690[i11], anIntArray1690[i12], anIntArray1691[i10], anIntArray1691[i11], anIntArray1691[i12], anIntArray1662[i]);
                    return;
                }
                if (i8 == 3) {
                    ...
                    Class50_Sub1_Sub1_Sub4.method507(i7, j7, k7, j3, j4, j5, anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[j10], anIntArray1689[j11], anIntArray1689[j12], anIntArray1690[j10], anIntArray1690[j11], anIntArray1690[j12], anIntArray1691[j10], anIntArray1691[j11], anIntArray1691[j12], anIntArray1662[i]);
                    Class50_Sub1_Sub1_Sub4.method507(i7, k7, anIntArray1700[3], j3, j5, anIntArray1699[3], anIntArray1656[i], anIntArray1656[i], anIntArray1656[i], anIntArray1689[j10], anIntArray1689[j11], anIntArray1689[j12], anIntArray1690[j10], anIntArray1690[j11], anIntArray1690[j12], anIntArray1691[j10], anIntArray1691[j11], anIntArray1691[j12], anIntArray1662[i]);
                }
            }
        }
    }

    public boolean method602(int i, int j, int k, int l, int i1, int j1, int k1,
                             int l1) {
        if (j < k && j < l && j < i1)
            return false;
        if (j > k && j > l && j > i1)
