...
public class Class50_Sub1_Sub1_Sub1 extends Class50_Sub1_Sub1 {
    ...
    public Class50_Sub1_Sub1_Sub1(Class2 class2, String s, int i) {
        ...
        aBoolean1487 = true;
        anInt1488 = 3600;
        Stream class50_sub1_sub2 = new Stream(true, class2.method154(s + ".dat", null));
        Stream class50_sub1_sub2_1 = new Stream(true, class2.method154("index.dat", null));
    ...
    public void method456(boolean flag) {
        if (flag) {
            ...
            method444(aBoolean1487, anInt1490, anInt1491, anIntArray1489);
            return;
        }
    }
    ...
    public void method459(int i, int j, int k) {
        ...
        if (k1 <= 0 || j1 <= 0)
            return;
        method460(k1, l1, j1, anIntArray1489, i1, i2, l, (byte) -39, anIntArray1424);
        if (j >= 0)
            aBoolean1487 = !aBoolean1487;
    }
    ...
    public void method461(int i, int j, int k) {
        ...
        if (k1 <= 0 || j1 <= 0) {
            ...
            method462(anIntArray1424, anIntArray1489, 0, i1, l, k1, j1, l1, i2);
            return;
        }
    }
    ...
    public void method463(int i, int j, int k, int l) {
        ...
        if (l1 <= 0 || k1 <= 0) {
            ...
            method464(l1, j2, 0, i2, j1, anInt1481, l, i1, k1, anIntArray1424, anIntArray1489);
            return;
        }
    }
    ...
    public void method465(int i, int j, int k, int l, int i1, int ai[], int j1,
        ...
        try {
            ...
            for (i = 0; i < k; i++) {
                ...
                int l4 = k3 - l2 * i4;
                for (j1 = -ai[i]; j1 < 0; j1++) {
                    anIntArray1424[j4++] = anIntArray1489[(k4 >> 16) + (l4 >> 16) * anInt1490];
                    k4 += i3;
                    l4 -= l2;
                }
    ...
    public void method467(Class50_Sub1_Sub1_Sub3 class50_sub1_sub1_sub3, int i, int j, int k) {
        ...
        if (k1 <= 0 || j1 <= 0) {
            ...
            method468(l, l1, anIntArray1489, k1, anIntArray1424, class50_sub1_sub1_sub3.aByteArray1516, 40303, j1, i1, 0, i2);
            return;
        }
    }
