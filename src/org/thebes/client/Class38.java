...
public class Class38 {
    ...
    public static Stream aClass50_Sub1_Sub2_671;
    public int anInt665;
    public int anInt666;
    ...
    public static void method365(Stream class50_sub1_sub2, int i) {
        if (i != 36135)
            return;
        aByteArray670 = new byte[0x6baa8];
        aClass50_Sub1_Sub2_671 = new Stream(true, aByteArray670);
        Class11.method190();
        do {
            ...
            aClass38Array668[j].method367(aByte664, class50_sub1_sub2);
            anIntArray669[j] = aClass38Array668[j].method368(0);
        } while (true);
    }

    public static Stream method366(int i, byte byte0, int j) {
        if (byte0 != 6)
    ...
    public void method367(byte byte0, Stream class50_sub1_sub2) {
        for (int i = 0; i < 10; i++) {
    ...
    public Stream method369(int i, int j) {
        int k = method370(j);
