package org.thebes.client;/* org.thebes.client.Class8 - Decompiled by JODE
...
public class Class8 {
    ...
    public static void method169(Class32_Sub1 class32_sub1,
                                 Stream class50_sub1_sub2, byte i) {
        if (i == -3) {
            int i_159_ = -1;
            for (; ; ) {
    ...
    public static boolean method181(int i, int i_258_, byte[] is, int i_259_) {
        boolean bool = true;
        Stream class50_sub1_sub2 = new Stream(true, is);
        if (i_259_ != 24515)
            throw new NullPointerException();
        int i_260_ = -1;
        for (; ; ) {
        ...
        for (int i_217_ = 0; i_217_ < 4; i_217_++) {
            for (int i_218_ = 0; i_218_ < 64; i_218_++) {
                for (int i_219_ = 0; i_219_ < 64; i_219_++)
                    method183(i_213_, (byte) -61, i_211_, class50_sub1_sub2, 0,
    ...
    public void method183(int i, byte i_272_, int i_273_,
                          Stream class50_sub1_sub2, int i_274_,
