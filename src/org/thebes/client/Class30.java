...
public class Class30 {
    ...
    public static Class1 aClass1_586 = new Class1();

    public static int method312(byte abyte0[], int i, byte abyte1[], int j, int k) {
        synchronized (aClass1_586) {
            aClass1_586.aByteArray47 = abyte1;
            aClass1_586.anInt48 = k;
            aClass1_586.aByteArray52 = abyte0;
            aClass1_586.anInt53 = 0;
            aClass1_586.anInt49 = j;
            aClass1_586.anInt54 = i;
            aClass1_586.anInt61 = 0;
            aClass1_586.anInt60 = 0;
            aClass1_586.anInt50 = 0;
            aClass1_586.anInt51 = 0;
            aClass1_586.anInt55 = 0;
            aClass1_586.anInt56 = 0;
            aClass1_586.anInt63 = 0;
            method314(aClass1_586);
            i -= aClass1_586.anInt54;
            int l = i;
            return l;
        }
    }

    public static void method313(Class1 class1) {
        byte byte4 = class1.aByte57;
        int i = class1.anInt58;
        int j = class1.anInt68;
        int k = class1.anInt66;
        int ai[] = Class1.anIntArray71;
    ...
    public static void method314(Class1 class1) {
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        boolean flag3 = false;
        ...
        int ai2[] = null;
        class1.anInt62 = 1;
        if (Class1.anIntArray71 == null)
            Class1.anIntArray71 = new int[class1.anInt62 * 0x186a0];
        boolean flag19 = true;
        while (flag19) {
            ...
            for (int l3 = 0; l3 < j4; l3++) {
                ...
                method319(class1.anIntArrayArray81[l3], class1.anIntArrayArray82[l3], class1.anIntArrayArray83[l3], class1.aByteArrayArray80[l3], byte8, i, i4);
            ...
            for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; )
                if (k5 == 0 || k5 == 1) {
                    ...
                    for (; j6 > 0; j6--) {
                        Class1.anIntArray71[i6] = byte5 & 0xff;
                        i6++;
                    }
                    ...
                    Class1.anIntArray71[i6] = class1.aByteArray75[byte6 & 0xff] & 0xff;
                    i6++;
                    if (j5 == 0) {
                        i5++;
                        j5 = 50;
            ...
            for (int l2 = 0; l2 < i6; l2++) {
                byte byte7 = (byte) (Class1.anIntArray71[l2] & 0xff);
                Class1.anIntArray71[class1.anIntArray69[byte7 & 0xff]] |= l2 << 8;
                class1.anIntArray69[byte7 & 0xff]++;
            }

            class1.anInt65 = Class1.anIntArray71[class1.anInt64] >> 8;
            class1.anInt68 = 0;
            class1.anInt65 = Class1.anIntArray71[class1.anInt65];
    ...
    public static byte method315(Class1 class1) {
        return (byte) method317(8, class1);
    }

    public static byte method316(Class1 class1) {
        return (byte) method317(1, class1);
    }

    public static int method317(int i, Class1 class1) {
        int j;
        do {
            if (class1.anInt61 >= i) {
    ...
    public static void method318(Class1 class1) {
        class1.anInt72 = 0;
        for (int i = 0; i < 256; i++)
