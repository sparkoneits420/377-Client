...
public class Class45 {
    ...
    public static void method373(Class2 class2) {
        Stream class50_sub1_sub2 = new Stream(true, class2.method154("fragmentsenc.txt", null));
        Stream class50_sub1_sub2_1 = new Stream(true, class2.method154("badenc.txt", null));
        Stream class50_sub1_sub2_2 = new Stream(true, class2.method154("domainenc.txt", null));
        Stream class50_sub1_sub2_3 = new Stream(true, class2.method154("tldlist.txt", null));
        method374(class50_sub1_sub2, class50_sub1_sub2_1, class50_sub1_sub2_2, class50_sub1_sub2_3);
    }

    public static void method374(Stream class50_sub1_sub2, Stream class50_sub1_sub2_1, Stream class50_sub1_sub2_2, Stream class50_sub1_sub2_3) {
    ...
    public static void method375(Stream class50_sub1_sub2, int i) {
    ...
    public static void method376(boolean flag, Stream class50_sub1_sub2) {
        if (!flag) {
            return;
        } else {
    ...
    public static void method377(int i, Stream class50_sub1_sub2) {
        int j = class50_sub1_sub2.method526();
    ...
    public static void method378(Stream class50_sub1_sub2, int i) {
        if (i != 21901)
            return;
    ...
    public static void method379(int i, Stream class50_sub1_sub2, char ac[][], byte abyte0[][][]) {
    ...
    public static void method380(Stream class50_sub1_sub2, char ac[][], int i) {
        if (i != -37125)
            anInt728 = 218;
        for (int j = 0; j < ac.length; j++) {
            char ac1[] = new char[class50_sub1_sub2.method521()];
