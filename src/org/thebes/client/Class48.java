...
public class Class48 {
    ...
    public static void method434(Class2 class2, int i) {
        Stream class50_sub1_sub2 = new Stream(true, class2.method154("idk.dat", null));
        ...
        for (int j = 0; j < anInt814; j++) {
            ...
            aClass48Array815[j].method435(aByte811, class50_sub1_sub2);
        }

        if (i == 36135) ;
    }

    public void method435(byte byte0, Stream class50_sub1_sub2) {
        if (byte0 == 6)
            byte0 = 0;
        else
